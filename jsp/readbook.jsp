  ...
  <div class="bdsub" id="amain">
    <dl>
      <dd>
		...
		File file=new File(path+"/others/compare.txt");
		...
		while((temp=reader.readLine())!=null){
			...
			//out.println(array[1]);
			if(str.equals(array[0].replace(".txt",""))){
      ...
      <dd>
        <h3> <a href="../books_pinyin/<%=((name_pinyin==null)?str:name_pinyin)%>.txt"  download="<%=str%>" target= "_self " title="download">&nbsp&nbsp下载全本&nbsp&nbsp</a>
		<a href="/topreading/comment.jsp" title="comment">&nbsp&nbsp发表评论</a>  </h3>
      </dd>
